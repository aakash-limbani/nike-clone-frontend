...
export const Footer = () => {
    ...
    return (
        <Box h={'300px'} bg={'black'} color={'white'} mt={'40px'}>
            ...
            <Center h={'80px'}>
                <Text className="typeWritertheme">Made with <Icon as={FcLike} /> by Aakash Limbani</Text>
            </Center>
            ...
            >
                ...
                >
                    <IconLink
                        icon={FaGithub}
                        link={"https://github.com/aakash-limbani/"}
                    />
                    <IconLink
                        icon={FaLinkedin}
                        link={"https://www.linkedin.com/in/aakash-limbani/"}
                    />
                </Flex>
